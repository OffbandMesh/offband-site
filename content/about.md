...
- [meshcore-client](https://github.com/OffbandMesh/meshcore-client) — the app
- [meshcore-firmware](https://github.com/OffbandMesh/meshcore-firmware) — the firmware
- [OffbandMesh](https://github.com/OffbandMesh) — the org
